...
( function( $ ) {
	...
	// Logo
	wp.customize( 'v5gcuk_logo', function( value ) {
		value.bind( function( to ) {
			if ( to != "" ) {
				var logo = '<img src="' + to + '" />';
    ...
    */
		//Featured Color
		wp.customize( 'v5gcuk_hero_color', function( value ) {
			value.bind( function( to ) {
		...
		//Text Color
		wp.customize( 'v5gcuk_text_color', function( value ) {
			value.bind( function( to ) {
				$( 'body' ).css( {
						'color': to
				} );
		...
		//Link Color
		wp.customize( 'v5gcuk_link_color', function( value ) {
			value.bind( function( to ) {
				$( 'a' ).css( {
						'color': to
				} );
    ...
    */
    	...
    	------------------------------ */
    	//Welcome Message
		wp.customize( 'v5gcuk_welcome_title', function( value ) {
			value.bind( function( to ) {
				$( '.welcome-intro .intro-line' ).text( to );
			} );
		} );
		//Link Title
		wp.customize( 'v5gcuk_welcome_link_title', function( value ) {
			value.bind( function( to ) {
				$( '.welcome-section .btn-ql' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'v5gcuk_welcome_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.welcome-section .btn-ql' ).attr( 'href', to );
			} );
		} );
		//Background Image
		wp.customize( 'v5gcuk_welcome_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
		...
		wp.customize( 'v5gcuk_welcome_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Enable/Disable Section
		wp.customize( 'v5gcuk_services_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Quote
		wp.customize( 'v5gcuk_quote', function( value ) {
			value.bind( function( to ) {
				$( '.quote-section .quote-wrap blockquote' ).text( to );
			} );
		} );
		//Quote Author
		wp.customize( 'v5gcuk_quote_cite', function( value ) {
			value.bind( function( to ) {
				$( '.quote-section .quote-cite' ).html( to );
			} );
		} );
		//Quote Image
		wp.customize( 'v5gcuk_quote_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "") {
					$.ajax({
		...
		//Background Color
		wp.customize( 'v5gcuk_quote_bck_color', function( value ) {
			value.bind( function( to ) {
				$( '.quote-background' ).css( 'background-color', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'v5gcuk_quote_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.quote-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'v5gcuk_video_title', function( value ) {
			value.bind( function( to ) {
				$( '.video-section .video-text-wrap .video-text-title' ).text( to );
			} );
		} );
		//Text
		wp.customize( 'v5gcuk_video_text', function( value ) {
			value.bind( function( to ) {
				$( '.video-section .video-text-wrap p' ).html( to );
			} );
		} );
		//Link Title
		wp.customize( 'v5gcuk_video_link_title', function( value ) {
			value.bind( function( to ) {
				$( '.video-section .btn-ql' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'v5gcuk_video_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.video-section .btn-ql' ).attr( 'href', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'v5gcuk_video_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.video-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Background Image
		wp.customize( 'v5gcuk_testimonial_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
		...
		//Enable/Disable Section
		wp.customize( 'v5gcuk_testimonial_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Featured Image
		wp.customize( 'v5gcuk_image_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
    	...
    	//Title
		wp.customize( 'v5gcuk_image_title', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .image-text .image-text-title' ).text( to );
			} );
		} );
		//Text
		wp.customize( 'v5gcuk_image_text', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .image-text p' ).html( to.replace(/\n\r?/g, '<br />') );
			} );
		} );
		//Link Title
		wp.customize( 'v5gcuk_image_link_title', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .btn-ql' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'v5gcuk_image_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.image-section .btn-ql' ).attr( 'href', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'v5gcuk_image_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.image-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'v5gcuk_team_title', function( value ) {
			value.bind( function( to ) {
				$( '.team-section .section-title' ).text( to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'v5gcuk_team_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.team-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Phone Image
		wp.customize( 'v5gcuk_phone_image', function( value ) {
			value.bind( function( to ) {
				if ( to != "" ) {
					$.ajax({
						url: wp_customizer.ajax_url,
		...
		//Link Title
		wp.customize( 'v5gcuk_phone_link_title', function( value ) {
			value.bind( function( to ) {
				$( '.phone-section .btn-ql' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'v5gcuk_phone_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.phone-section .btn-ql' ).attr( 'href', to );
			} );
		} );
		//Background Color
		wp.customize( 'v5gcuk_phone_bck_color', function( value ) {
			value.bind( function( to ) {
				$( '.phone-section' ).css( 'background-color', to );
			} );
		} );
		//Phone Color
		wp.customize( 'v5gcuk_phone_color', function( value ) {
			value.bind( function( to ) {
				if ( to == "gray" ) {
		...
		//Enable/Disable Section
		wp.customize( 'v5gcuk_phone_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.phone-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'v5gcuk_tagline_text', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section .tagline' ).text( to );
			} );
		} );
		//Sub-text
		wp.customize( 'v5gcuk_tagline_sub_text', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section span' ).text( to );
			} );
		} );
		//Link URL
		wp.customize( 'v5gcuk_tagline_link_url', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section a' ).attr( 'href', to );
			} );
		} );
		//Background Color
		wp.customize( 'v5gcuk_tagline_bck_color', function( value ) {
			value.bind( function( to ) {
				$( '.tagline-section' ).css( 'background-color', to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'v5gcuk_tagline_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'v5gcuk_clients_title', function( value ) {
			value.bind( function( to ) {
				$( '.clients-section .section-title' ).text( to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'v5gcuk_clients_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'v5gcuk_map_title', function( value ) {
			value.bind( function( to ) {
				$( '.map-section .section-title' ).text( to );
			} );
		} );
		//Text
		wp.customize( 'v5gcuk_map_text', function( value ) {
			value.bind( function( to ) {
				$( '.map-section .map-text' ).html( to.replace(/\n\r?/g, '<br />') );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'v5gcuk_map_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.map-section' ).show();	
				}else{
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'v5gcuk_pricing_title', function( value ) {
			value.bind( function( to ) {
				$( '.pricing-section .section-title' ).text( to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'v5gcuk_pricing_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'v5gcuk_portfolio_title', function( value ) {
			value.bind( function( to ) {
				$( '.portfolio-section .section-title' ).text( to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'v5gcuk_portfolio_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
    	...
    	------------------------------ */
    	//Title
		wp.customize( 'v5gcuk_blog_title', function( value ) {
			value.bind( function( to ) {
				$( '.blog-section .section-title' ).text( to );
			} );
		} );
		//Enable/Disable Section
		wp.customize( 'v5gcuk_blog_enable', function( value ) {
			value.bind( function( to ) {
				if ( to == true ) {
					$( '.blog-section' ).show();	
				}else{
