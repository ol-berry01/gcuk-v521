	...
	<div class="container">
		<main id="main" class="site-main col-md-12" role="main" style="padding-bottom:5rem;">
			<header class="page-header">
				<h1 class="page-title">Used Vehicles</h1>
				<?php the_archive_description( '<div class="taxonomy-description">', '</div>' ); ?>
			</header>
			<div class="button-group filters-button-group">
				<button class="button is-checked" data-filter="*">All Used Vehicles</button>
			...
			<div class="vehicle-grid" style="margin:0 -20px;">
				<?php
					$vehiclesArchive = new WP_Query(array(
						'posts_per_page' 	=> -1,
						'post_type' 		=> 'used_vehicle',
						'orderby'			=> 'category',
						'order'				=> 'ASC'
					));
					while($vehiclesArchive->have_posts()) {
                        $vehiclesArchive->the_post();
                            get_template_part( 'template-parts/content-vehicle', get_post_format() );  
                    }; ?>
			</div>
